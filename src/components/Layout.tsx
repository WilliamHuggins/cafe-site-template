...
export default function Layout() {
  ...
  const navLinks = [
    { name: t('layout.nav.menu'), path: '/#menu' },
    { name: t('layout.nav.family'), path: '/about' },
    { name: t('layout.nav.careers'), path: '/careers' },
    { name: t('layout.nav.mobileBar'), path: '/mobile-bar' },
    { name: t('layout.nav.giftCards'), path: '/gift-cards' },
  ];
  ...
  useEffect(() => {
    const shouldScrollToMenu = location.pathname === '/' && sessionStorage.getItem('scrollToMenu') === 'true';
      ...
      <footer className="bg-section-bg dark:bg-dark-section-bg py-20 mt-auto transition-colors">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="flex flex-col gap-4">
              ...
              <a href="/#menu" className="text-sm text-secondary-text dark:text-dark-secondary-text hover:text-black dark:hover:text-white transition-colors">{t('layout.nav.menu')}</a>
              <Link to="/about" className="text-sm text-secondary-text dark:text-dark-secondary-text hover:text-black dark:hover:text-white transition-colors">{t('layout.nav.family')}</Link>
              <Link to="/mobile-bar" className="text-sm text-secondary-text dark:text-dark-secondary-text hover:text-black dark:hover:text-white transition-colors">{t('layout.nav.mobileBar')}</Link>
            </div>
            <div className="flex flex-col gap-4">
              ...
              <Link to="/careers" className="text-sm text-secondary-text dark:text-dark-secondary-text hover:text-black dark:hover:text-white transition-colors">{t('layout.nav.careers')}</Link>
              <Link to="/subscribe" className="text-sm text-secondary-text dark:text-dark-secondary-text hover:text-black dark:hover:text-white transition-colors">{t('layout.nav.connect')}</Link>
            ...
            <div className="flex flex-col gap-4">
              ...
              <Link to="/gift-cards" className="text-sm text-secondary-text dark:text-dark-secondary-text hover:text-black dark:hover:text-white transition-colors">{t('layout.nav.giftCards')}</Link>
            </div>
            <div className="flex flex-col gap-4">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 mt-16 pt-8 border-t border-border-light dark:border-border-dark flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <Link to="/privacy" className="text-xs text-muted-text dark:text-dark-muted-text hover:text-black dark:hover:text-white transition-colors">{t('layout.footer.privacy')}</Link>
            <Link to="/terms" className="text-xs text-muted-text dark:text-dark-muted-text hover:text-black dark:hover:text-white transition-colors">{t('layout.footer.terms')}</Link>
          </div>
        </div>
      </footer>
    </div>
