        ...
        {showPrototypeBanner && (
          <div className="max-w-7xl mx-auto px-6 md:px-12 mt-8 pt-6 border-t border-border-light dark:border-border-dark">
            <p className="text-xs text-muted-text dark:text-dark-muted-text leading-relaxed text-center">
              Palm & Light Coffee is a fictional business. All brand names, logos, images, and content were generated by AI and do not represent a real company. This project is open-source under the Apache 2.0 License and free to use for learning, teaching, and prototyping.
            </p>
          </div>
        )}
      </footer>
