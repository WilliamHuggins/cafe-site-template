    ...
    <div className="min-h-screen flex flex-col bg-[#fbf9f8] dark:bg-[#121212] text-[#1b1c1c] dark:text-[#fbf9f8] font-sans selection:bg-[#e5e2e1] dark:selection:bg-[#444748] transition-colors duration-300">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
          <Link to="/" className={`flex items-center gap-3 group ${transparentNav ? 'text-white' : 'text-black dark:text-white'}`}>
            ...
            <span className="text-xl font-bold tracking-tight whitespace-nowrap">KAIZEN & COFFEE</span>
          </Link>
