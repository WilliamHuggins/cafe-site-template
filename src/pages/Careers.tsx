  ...
  return (
    <div className="pt-32 pb-24 bg-[#fbf9f8] dark:bg-[#121212] min-h-screen transition-colors">
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        ...
        <div className="aspect-[21/9] rounded-2xl overflow-hidden bg-[#efeded] dark:bg-[#1a1a1a] mb-16">
          <img 
        ...
        <div className="space-y-16">
          ...
          <section className="bg-[#efeded] dark:bg-[#1a1a1a] p-10 rounded-2xl transition-colors">
