  ...
  return (
    <div className="bg-[#fbf9f8] dark:bg-[#121212] text-[#1b1c1c] dark:text-[#F5EDE3] font-sans overflow-x-hidden transition-colors duration-300 pt-20">
      ...
      <section className="min-h-[80vh] flex flex-col justify-center items-center text-center px-8 py-20 relative">
        ...
        <div className="font-jp font-light text-6xl md:text-8xl text-[#1b1c1c]/15 dark:text-[#F5EDE3]/15 tracking-[0.5em] mb-4 animate-[fadeDown_1.2s_ease-out_both]">
          改善
        </div>
        <h1 className="font-serif font-normal text-4xl md:text-6xl lg:text-7xl leading-[1.15] max-w-3xl text-[#1b1c1c] dark:text-[#F5EDE3] animate-[fadeDown_1.2s_ease-out_0.15s_both]">
        ...
        <div className="absolute bottom-10 flex flex-col items-center gap-2 animate-[fadeDown_1.2s_ease-out_0.6s_both]">
          ...
          <div className="w-px h-10 bg-[#1b1c1c] dark:bg-[#F5EDE3] opacity-25 animate-[pulse_2s_ease-in-out_infinite]"></div>
        </div>
      </section>
      ...
      <section className="py-28 px-8 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center fade-in-section opacity-0 translate-y-8 transition-all duration-1000 ease-out">
          <div>
            <h2 className="font-serif font-normal text-3xl md:text-4xl lg:text-5xl leading-tight mb-8 text-[#1b1c1c] dark:text-[#F5EDE3]">
              It started with <em className="italic text-[#7A8B5E]">sleepless nights</em>
            </h2>
            <div className="space-y-5 text-[0.95rem] leading-[1.85] text-[#1b1c1c]/75 dark:text-[#F5EDE3]/75">
          ...
          <div className="relative">
            <div className="bg-[#f1efee] dark:bg-[#1A1A1A] rounded-2xl p-12 relative overflow-hidden">
              <div className="absolute -top-4 -right-2 font-jp font-light text-[8rem] text-[#1b1c1c]/15 dark:text-[#F5EDE3]/15 leading-none">
                改善
              </div>
              <div className="text-xs tracking-[0.15em] uppercase text-[#7A8B5E] mb-3 font-medium relative z-10">
                Japanese · noun
              </div>
              <div className="font-serif text-4xl font-medium mb-1 relative z-10 text-[#1b1c1c] dark:text-[#F5EDE3]">
                Kaizen
              </div>
              <div className="font-jp text-lg text-[#1b1c1c]/50 dark:text-[#F5EDE3]/50 mb-6 font-light relative z-10">
                改善 · かいぜん
              </div>
              <div className="text-[0.95rem] leading-[1.7] text-[#1b1c1c]/70 dark:text-[#F5EDE3]/70 border-t border-[#1b1c1c]/10 dark:border-[#F5EDE3]/10 pt-5 italic relative z-10">
      ...
      <div className="max-w-5xl mx-auto px-8 pb-8 fade-in-section opacity-0 translate-y-8 transition-all duration-1000 ease-out">
        <figure className="relative rounded-2xl overflow-hidden shadow-[0_20px_60px_rgba(27,28,28,0.12)] dark:shadow-none">
          ...
          />
          <figcaption className="absolute bottom-0 left-0 right-0 p-12 pt-24 bg-gradient-to-t from-[#1b1c1c]/80 to-transparent text-[#F5EDE3] text-sm tracking-wide italic">
      ...
      <div className="flex items-center justify-center gap-6 py-8 max-w-md mx-auto">
        <div className="flex-1 h-px bg-[#1b1c1c]/10 dark:bg-[#F5EDE3]/10"></div>
        <div className="w-1.5 h-1.5 rounded-full bg-[#A3B18A]"></div>
        <div className="flex-1 h-px bg-[#1b1c1c]/10 dark:bg-[#F5EDE3]/10"></div>
      </div>

      {/* Journey Timeline */}
      <section className="bg-gradient-to-br from-[#1b1c1c] to-[#2a2b2b] dark:from-[#1b1c1c] dark:to-[#1b1c1c] text-[#F5EDE3] py-28 px-8 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none" style={{
      ...
      <section className="py-28 px-8 max-w-6xl mx-auto">
        <div className="fade-in-section opacity-0 translate-y-8 transition-all duration-1000 ease-out">
          ...
          <h2 className="font-serif font-normal text-3xl md:text-4xl lg:text-5xl leading-tight text-[#1b1c1c] dark:text-[#F5EDE3] mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-10 border border-[#1b1c1c]/10 dark:border-[#F5EDE3]/10 rounded-xl transition-all duration-400 hover:bg-[#f1efee] dark:hover:bg-[#1A1A1A] hover:border-transparent hover:-translate-y-1">
                <span className="text-2xl mb-5 block text-[#1b1c1c] dark:text-[#F5EDE3]">{value.icon}</span>
                <h3 className="font-serif text-2xl font-medium mb-3 text-[#1b1c1c] dark:text-[#F5EDE3]">{value.title}</h3>
                <p className="text-[0.88rem] leading-[1.75] text-[#1b1c1c]/65 dark:text-[#F5EDE3]/65">{value.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Partners */}
      <section className="bg-[#f1efee] dark:bg-[#1A1A1A] py-20 px-8 text-center transition-colors">
        <div className="max-w-4xl mx-auto fade-in-section opacity-0 translate-y-8 transition-all duration-1000 ease-out">
          ...
          <h2 className="font-serif font-normal text-3xl md:text-4xl mb-10 text-[#1b1c1c] dark:text-[#F5EDE3]">
            ...
            {[
              ...
              <div key={i} className="flex flex-col items-center gap-2">
                <div className="font-serif text-lg font-medium">
                  <a href={partner.link} target="_blank" rel="noopener noreferrer" className="text-[#1b1c1c] dark:text-[#F5EDE3] border-b border-[#1b1c1c]/15 dark:border-[#F5EDE3]/15 pb-0.5 hover:text-[#7A8B5E] hover:border-[#7A8B5E] dark:hover:text-[#7A8B5E] dark:hover:border-[#7A8B5E] transition-all">
                    {partner.name}
                  </a>
                </div>
                <div className="text-[0.78rem] text-[#1b1c1c]/50 dark:text-[#F5EDE3]/50 tracking-[0.06em]">
                  {partner.loc}
                </div>
              </div>
            ))}
      ...
      <section className="text-center py-28 px-8 relative">
        ...
        <div className="relative z-10 fade-in-section opacity-0 translate-y-8 transition-all duration-1000 ease-out">
          ...
          <h2 className="font-serif font-normal text-3xl md:text-4xl lg:text-5xl mb-6 text-[#1b1c1c] dark:text-[#F5EDE3]">
            We saved you <em className="italic text-[#7A8B5E]">a seat.</em>
          </h2>
          <p className="text-[0.95rem] leading-[1.7] text-[#1b1c1c]/65 dark:text-[#F5EDE3]/65 mb-2">
          ...
          <a 
            ...
            className="inline-flex items-center gap-2 mt-8 text-[#1b1c1c] dark:text-[#F5EDE3] text-[0.85rem] tracking-[0.08em] uppercase font-medium border-2 border-[#1b1c1c]/20 dark:border-[#F5EDE3]/20 px-7 py-3 rounded-full hover:bg-[#1b1c1c] hover:text-[#F5EDE3] dark:hover:bg-[#F5EDE3] dark:hover:text-[#1b1c1c] hover:border-[#1b1c1c] dark:hover:border-[#F5EDE3] transition-all"
          >
            @kaizenandcoffee
          </a>
        </div>
