        ...
        <div className="fade-in-section opacity-0 translate-y-8 transition-all duration-1000 ease-out">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-10 border border-[#1b1c1c]/10 dark:border-[#F5EDE3]/10 rounded-2xl transition-all duration-400 hover:bg-[#f1efee] dark:hover:bg-[#1A1A1A] hover:border-transparent hover:-translate-y-1">
      ...
      <section className="text-center py-28 px-8 relative">
        ...
        <div className="relative z-10 fade-in-section opacity-0 translate-y-8 transition-all duration-1000 ease-out">
          ...
          <a 
            ...
            className="inline-flex items-center gap-2 mt-8 text-[#1b1c1c] dark:text-[#F5EDE3] text-[0.85rem] tracking-[0.08em] uppercase font-medium border-2 border-[#1b1c1c]/20 dark:border-[#F5EDE3]/20 px-7 py-3 rounded-sm hover:bg-[#1b1c1c] hover:text-[#F5EDE3] dark:hover:bg-[#F5EDE3] dark:hover:text-[#1b1c1c] hover:border-[#1b1c1c] dark:hover:border-[#F5EDE3] transition-all"
          >
            @kaizenandcoffee
          </a>
        </div>
