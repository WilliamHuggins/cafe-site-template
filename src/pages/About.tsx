...
export default function About() {
  ...
  return (
    <>
      <Helmet>
        <title>The Kaizen Family | Our Story</title>
        <meta name="description" content="Learn the story behind Kaizen & Coffee, the family-owned San Mateo cafe built on continuous improvement, craft, and community." />
      </Helmet>
