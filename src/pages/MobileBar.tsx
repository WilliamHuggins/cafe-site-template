    ...
    <div className="bg-[#FAF7F2] dark:bg-[#121212] text-[#2C1810] dark:text-[#F5EDE3] font-dm overflow-x-hidden transition-colors duration-300 pt-20">
      ...
      <section className="min-h-[90vh] flex flex-col lg:flex-row items-center px-8 py-20 max-w-7xl mx-auto gap-16">
        <div className="flex-1 fade-in-section opacity-0 translate-y-8 transition-all duration-1000 ease-out">
          <h1 className="font-serif font-normal text-5xl md:text-6xl lg:text-7xl leading-[1.05] mb-8 text-[#1A1411] dark:text-[#F5EDE3] tracking-tight">
            The Best Part of Your Next Event? <br/>
            <em className="italic text-[#7A8B5E]">The Coffee.</em>
          </h1>
          <p className="text-lg md:text-xl leading-[1.7] text-[#2C1810]/75 dark:text-[#F5EDE3]/75 mb-12 max-w-lg">
          ...
          <button 
            ...
            className="inline-flex items-center gap-3 text-sm tracking-[0.15em] uppercase font-medium border border-[#2C1810]/20 dark:border-[#F5EDE3]/20 px-8 py-4 rounded-full hover:bg-[#2C1810] hover:text-[#F5EDE3] dark:hover:bg-[#F5EDE3] dark:hover:text-[#2C1810] hover:border-[#2C1810] dark:hover:border-[#F5EDE3] transition-all group"
          >
            PLAN YOUR EVENT
      ...
      {/* Let's Talk Coffee */}
      <section className="py-28 px-8 bg-[#E8DDD0] dark:bg-[#1A1A1A] transition-colors">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center fade-in-section opacity-0 translate-y-8 transition-all duration-1000 ease-out">
            ...
            <div className="order-1 lg:order-2">
              <h2 className="font-serif font-normal text-3xl md:text-4xl lg:text-5xl mb-8 text-[#1A1411] dark:text-[#F5EDE3]">
                Let's Talk Coffee
              </h2>
              <p className="text-lg md:text-xl leading-[1.8] text-[#2C1810]/80 dark:text-[#F5EDE3]/80">
      ...
      <section className="py-32 px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div className="fade-in-section opacity-0 translate-y-8 transition-all duration-1000 ease-out">
            <h2 className="font-serif font-normal text-3xl md:text-4xl mb-6 text-[#1A1411] dark:text-[#F5EDE3]">
              The Experience, <em className="italic text-[#7A8B5E]">Simplified.</em>
            </h2>
            <p className="text-lg leading-[1.7] text-[#2C1810]/70 dark:text-[#F5EDE3]/70 mb-10">
            ...
            <div className="space-y-8">
              <div>
                <h3 className="font-serif text-2xl font-medium mb-2 text-[#1A1411] dark:text-[#F5EDE3]">Passionate, Professional Baristas</h3>
                <p className="text-[0.95rem] leading-[1.7] text-[#2C1810]/70 dark:text-[#F5EDE3]/70">
              ...
              <div>
                <h3 className="font-serif text-2xl font-medium mb-2 text-[#1A1411] dark:text-[#F5EDE3]">Curated Specialty Menu</h3>
                <p className="text-[0.95rem] leading-[1.7] text-[#2C1810]/70 dark:text-[#F5EDE3]/70">
              ...
              <div>
                <h3 className="font-serif text-2xl font-medium mb-2 text-[#1A1411] dark:text-[#F5EDE3]">All the Good Stuff</h3>
                <p className="text-[0.95rem] leading-[1.7] text-[#2C1810]/70 dark:text-[#F5EDE3]/70">
          ...
          <div className="fade-in-section opacity-0 translate-y-8 transition-all duration-1000 delay-200 ease-out lg:mt-32">
            ...
            <div className="space-y-8">
              <div className="p-8 border border-[#2C1810]/10 dark:border-[#F5EDE3]/10 rounded-xl bg-white/50 dark:bg-black/20 backdrop-blur-sm">
                <h3 className="font-serif text-2xl font-medium mb-3 text-[#1A1411] dark:text-[#F5EDE3]">Corporate Events & Team Offsites</h3>
                <p className="text-[0.95rem] leading-[1.7] text-[#2C1810]/70 dark:text-[#F5EDE3]/70">
              ...
              <div className="p-8 border border-[#2C1810]/10 dark:border-[#F5EDE3]/10 rounded-xl bg-white/50 dark:bg-black/20 backdrop-blur-sm">
                <h3 className="font-serif text-2xl font-medium mb-3 text-[#1A1411] dark:text-[#F5EDE3]">Weddings & Rehearsals</h3>
                <p className="text-[0.95rem] leading-[1.7] text-[#2C1810]/70 dark:text-[#F5EDE3]/70">
              ...
              <div className="p-8 border border-[#2C1810]/10 dark:border-[#F5EDE3]/10 rounded-xl bg-white/50 dark:bg-black/20 backdrop-blur-sm">
                <h3 className="font-serif text-2xl font-medium mb-3 text-[#1A1411] dark:text-[#F5EDE3]">Private Parties & Community Meetups</h3>
                <p className="text-[0.95rem] leading-[1.7] text-[#2C1810]/70 dark:text-[#F5EDE3]/70">
      ...
      {/* Form Section */}
      <section id="inquiry-form" className="py-28 px-8 bg-gradient-to-b from-transparent to-[#E8DDD0]/50 dark:to-[#1A1A1A]/50">
        <div className="max-w-4xl mx-auto fade-in-section opacity-0 translate-y-8 transition-all duration-1000 ease-out">
          <div className="text-center mb-12">
            <h2 className="font-serif font-normal text-3xl md:text-4xl lg:text-5xl mb-4 text-[#1A1411] dark:text-[#F5EDE3]">
              Plan Your Event
            </h2>
            <p className="text-[0.95rem] leading-[1.7] text-[#2C1810]/65 dark:text-[#F5EDE3]/65">
              Fill out the form below to request a custom proposal for your next gathering.
            </p>
          </div>
          
          <div className="bg-[#f8f5f2] dark:bg-[#1A1A1A] rounded-2xl shadow-2xl overflow-hidden border border-[#2C1810]/10 dark:border-[#F5EDE3]/10 relative min-h-[800px] p-2 md:p-3">
            {/* Loading placeholder */}
            <div className="absolute inset-0 flex items-center justify-center -z-10">
              <div className="w-8 h-8 border-2 border-[#7A8B5E] border-t-transparent rounded-full animate-spin"></div>
            </div>
            <div className="rounded-xl overflow-hidden border border-[#2C1810]/10 dark:border-[#F5EDE3]/10 bg-white dark:bg-[#202020] h-full">
              <iframe 
