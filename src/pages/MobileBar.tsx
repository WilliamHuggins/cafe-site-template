...
export default function MobileBar() {
  ...
  return (
    <>
      <Helmet>
        <title>Mobile Espresso Bar | Kaizen & Coffee</title>
        <meta name="description" content="Book Kaizen & Coffee's mobile espresso bar for Bay Area weddings, corporate events, and private gatherings with specialty coffee service." />
      </Helmet>
      ...
      <section className="min-h-[90vh] flex flex-col lg:flex-row items-center px-8 py-20 max-w-7xl mx-auto gap-16">
        <div className="flex-1 fade-in-section opacity-0 translate-y-8 transition-all duration-1000 ease-out">
          <h1 className="font-serif font-normal text-5xl md:text-6xl lg:text-7xl leading-[1.05] mb-8 text-foreground dark:text-dark-foreground tracking-tight">
            ...
            <em className="italic text-accent-green">The Coffee.</em>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div className="fade-in-section opacity-0 translate-y-8 transition-all duration-1000 ease-out">
            <h2 className="font-serif font-normal text-3xl md:text-4xl mb-6 text-foreground dark:text-dark-foreground">
              The Experience, <em className="italic text-accent-green">Simplified.</em>
            </h2>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="font-serif text-2xl font-medium mb-2 text-foreground dark:text-dark-foreground">Passionate, Professional Baristas</h3>
              ...
              <div>
                <h3 className="font-serif text-2xl font-medium mb-2 text-foreground dark:text-dark-foreground">Curated Specialty Menu</h3>
                <p className="text-[0.95rem] leading-[1.7] text-foreground/70 dark:text-dark-foreground/70">
              ...
              <div>
                <h3 className="font-serif text-2xl font-medium mb-2 text-foreground dark:text-dark-foreground">All the Good Stuff</h3>
                <p className="text-[0.95rem] leading-[1.7] text-foreground/70 dark:text-dark-foreground/70">
          ...
          <div className="fade-in-section opacity-0 translate-y-8 transition-all duration-1000 delay-200 ease-out lg:mt-32">
            <h2 className="font-serif font-normal text-3xl md:text-4xl mb-6 text-foreground dark:text-dark-foreground">
              A Better Experience for <em className="italic text-accent-green">Any Gathering.</em>
            </h2>
            <p className="text-lg leading-[1.7] text-foreground/70 dark:text-dark-foreground/70 mb-10">
            ...
            <div className="space-y-8">
              <div className="p-8 border border-foreground/10 dark:border-dark-foreground/10 rounded-2xl bg-white/50 dark:bg-black/20 backdrop-blur-sm">
                <h3 className="font-serif text-2xl font-medium mb-3 text-foreground dark:text-dark-foreground">Corporate Events & Team Offsites</h3>
                <p className="text-[0.95rem] leading-[1.7] text-foreground/70 dark:text-dark-foreground/70">
              ...
              <div className="p-8 border border-foreground/10 dark:border-dark-foreground/10 rounded-2xl bg-white/50 dark:bg-black/20 backdrop-blur-sm">
                <h3 className="font-serif text-2xl font-medium mb-3 text-foreground dark:text-dark-foreground">Weddings & Rehearsals</h3>
                <p className="text-[0.95rem] leading-[1.7] text-foreground/70 dark:text-dark-foreground/70">
              ...
              <div className="p-8 border border-foreground/10 dark:border-dark-foreground/10 rounded-2xl bg-white/50 dark:bg-black/20 backdrop-blur-sm">
                <h3 className="font-serif text-2xl font-medium mb-3 text-foreground dark:text-dark-foreground">Private Parties & Community Meetups</h3>
                <p className="text-[0.95rem] leading-[1.7] text-foreground/70 dark:text-dark-foreground/70">
