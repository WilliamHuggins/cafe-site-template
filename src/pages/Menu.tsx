...
export default function Menu() {
  ...
  return (
    <>
      <Helmet>
        <title>Our Menu | Kaizen & Coffee</title>
        <meta name="description" content="Explore the Kaizen & Coffee menu with espresso classics, signature seasonal creations, and curated offerings crafted in San Mateo." />
      </Helmet>
