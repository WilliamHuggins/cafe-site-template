      ...
      <section className="py-32 bg-[#fbf9f8] dark:bg-[#121212] transition-colors">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
            ...
            <div className="aspect-[4/5] rounded-2xl overflow-hidden bg-[#efeded] dark:bg-[#1a1a1a]">
              <img 
                    ...
                    {data.items.map((item, idx) => (
                      <div key={idx} className="bg-white dark:bg-[#121212] p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-[#dbdad9]/50 dark:border-[#303031]/50 flex flex-col group">
                        <div className="flex justify-between items-start mb-4 gap-4">
                          ...
                          <span className="text-sm font-bold bg-[#fbf9f8] dark:bg-[#1a1a1a] px-3 py-1 rounded-sm text-black dark:text-white whitespace-nowrap">{item.price}</span>
                        </div>
                        {item.description && (
      ...
      <section className="py-32 bg-[#fbf9f8] dark:bg-[#121212] transition-colors">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link to="/mobile-bar" className="bg-[#efeded] dark:bg-[#1a1a1a] p-12 flex flex-col justify-between min-h-[400px] group rounded-2xl hover:bg-[#e4e2e2] dark:hover:bg-[#252525] transition-colors">
            ...
            <Link to="/subscribe" className="bg-black dark:bg-white text-white dark:text-black p-12 flex flex-col justify-between min-h-[400px] group rounded-2xl hover:bg-[#1c1b1b] dark:hover:bg-[#e4e2e2] transition-colors">
            ...
            <Link to="/gift-cards" className="bg-[#efeded] dark:bg-[#1a1a1a] p-12 flex flex-col justify-between min-h-[400px] group rounded-2xl hover:bg-[#e4e2e2] dark:hover:bg-[#252525] transition-colors">
