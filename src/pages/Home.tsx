          ...
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
              <a 
                ...
                className="bg-accent-green text-white px-8 py-4 flex items-center gap-3 font-bold text-sm tracking-wide hover:bg-accent-green-hover transition-colors group rounded-sm"
              >
                VIEW MENU
      ...
      <section className="py-32 bg-background dark:bg-dark-bg transition-colors">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
            <div>
              <span className="uppercase tracking-[0.2em] text-xs font-bold text-accent-brown mb-6 block">Our Story</span>
              <h2 className="font-serif font-normal text-4xl md:text-5xl lg:text-6xl text-black dark:text-white mb-8 leading-[1.1]">
                ...
                <em className="italic text-accent-green">every single day.</em>
              </h2>
          ...
          <div className="max-w-3xl mx-auto text-center">
            <span className="uppercase tracking-[0.2em] text-xs font-bold text-accent-brown mb-6 block">The Philosophy</span>
            <h2 className="font-serif font-normal text-4xl md:text-5xl lg:text-6xl text-black dark:text-white leading-[1.1] mb-8">
              Kaizen: <em className="italic text-accent-green">Continuous Improvement.</em>
            </h2>
            <p className="text-secondary-text dark:text-dark-secondary-text text-lg leading-relaxed mb-8">
            ...
            <Link to="/about" className="inline-flex items-center gap-2 text-black dark:text-white font-bold border-b border-black dark:border-white pb-1 hover:text-accent-brown hover:border-accent-brown dark:hover:text-accent-brown dark:hover:border-accent-brown transition-colors">
              The Kaizen Family
            </Link>
          </div>
        </div>
